...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userList.add(User("Ashish", "Pokhrel", "apokhrel@gmail.com", "apple"))
        userList.add(User("din", "Basnet", "dkin@gmail.com", "ball"))
        userList.add(User("kam", "Shar", "rkam@gmail.com", "cat"))
        userList.add(User("Hari", "Pandit", "hari@gmail.com", "dog"))
        userList.add(User("Shyam", "Shrestha", "shyam@gmail.com", "eye"))
